...
export const FOIA_NORME = [
  ...
  { ref: 'D.Lgs. 33/2013, art. 5 c. 7', cosa: 'in caso di diniego/silenzio: riesame al RPCT entro 20 giorni, poi ricorso al TAR (art. 116 c.p.a.)', urn: 'urn:nir:stato:decreto.legislativo:2013-03-14;33~art5' },
...
export function helperFoia(oggetto: string, ente?: string) {
  ...
  return {
    ...
    rimedi: 'in caso di diniego o silenzio: riesame al RPCT entro 20 giorni (art. 5, c. 7), poi ricorso al TAR ex art. 116 c.p.a.; per enti locali, in alternativa, il difensore civico (art. 5, c. 8)',
